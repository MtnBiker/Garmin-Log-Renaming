...
i = 0
arrDatetime =  [["2013-01-14T16:26:58",["33.812228", "-118.383842"]], ["2013-09-20T03:38:42Z",["44.826124", "15.656795"]], ["2013-07-01T15:45:00Z",["33.812149", "-118.383686"]], ["2013-10-15T13:39:57Z", ["41.497393", "-81.592296"]], ["2010-10-20T13:23:55Z", ["27.797626", "87.126475"]]] # works with or without the Z at the end
...
while i < 5
  ...
  puts "\n51. timezoneId: #{timezoneId}."
  puts "52. gmtOffset: #{gmtOffset}. dstOffset: #{dstOffset}" # . isdst: #{isdst}.
...
#  Thought I could use tzi for some other conversions, but not working. Note that this is for the track time
...
#   tzn =  timeZ["dstOffset"] # what is different about this than timezoneID
 # puts "63. tzi: #{tzi}"
  ...
  # Knowing the time zone, tz, we use utc_to_local conversion for the time of the track timeUTC. tz uses TZInfo
...
#                             # => #<DateTime:  2001-05-06T04:05:06+07:00 ...> Doesn't change the time zone, just puts in whatever you put, i.e, doesn't assume UTC
  ...
  puts "\n97. timeLocal: #{timeLocal}. This is the correct LOCAL time, but shows UTC, but it's really some other time zone."
  
  #  Doesn't work. Ignores time zone correction AFAICS
  # timePretty = timeUTC.strftime("%A, %B %d, %Y %I:%M%p %Z")
#   puts "\n93. timePretty: #{timePretty}. But this is UTC and I want it local. Ignores time zone correction. "
  ...
  puts "\n105 timePretty: #{timePretty} with manually added time zone identifier"
  
  # dstTrue = tz.TimePeriod.dst?(Time.utc(timeUTC.year, timeUTC.month, timeUTC.day, timeUTC.hour, timeUTC.min, timeUTC.sec))
 #  puts "111. dstTrue: #{dstTrue}."
