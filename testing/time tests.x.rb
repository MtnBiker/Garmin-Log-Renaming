...
i = 0
arrDatetime =  [["2013-01-14T16:26:58Z",["33.812228", "-118.383842"]], ["2013-09-20T03:38:42Z",["44.826124", "15.656795"]], ["2013-07-01T15:45:00Z",["33.812149", "-118.383686"]], ["2013-10-15T13:39:57Z", ["41.497393", "-81.592296"]]]
...
while i < 5
  ...
  # Represents CA ST, Croatia, CA DST, Ohio EDT
  puts "arrDatetime[#{i}]: #{arrDatetime[i]}"
  myDatetime = arrDatetime[i][0]
  alation = arrDatetime[i][1]
  puts "myDatetime: #{myDatetime}."
